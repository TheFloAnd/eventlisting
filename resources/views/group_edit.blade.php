...
<input type="text" class="form-control" name="group_name" id="group_name"
                          placeholder="<?php echo$group->name ?:  lang['groups'] .' '.  lang['name'] ?>" value="<?php echo$group->name ?>"
                          required>
...
<input type="text" class="form-control" name="group_alias" id="group_alias"
                          placeholder="<?php echo $group->alias ?:  lang['groups'] .' '.  lang['alias'] ?>" value="<?php echo $group->alias ?>"
